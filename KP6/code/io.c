...
OSType getOSType(const char *type) {
    if (strcmp(type, "WINDOWS") == 0) return WINDOWS; //"windou", "windows" WINDOWS=WINDOWS
...
void student_print(Student *s)
{
    ...
    // Print video controller type as string
